...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Premium vacation rental properties in the most sought-after destinations. From beachfront villas to mountain retreats, I offer luxury accommodations for unforgettable holidays.",
      features: [
    ...
    },
    {
      ...
      description: "Complete interior design and furnishing solutions for your home. I transform spaces with premium furniture, decor, and personalized design consultations.",
      features: [
    ...
    <div className="page">
      <section className="content-section" style={{paddingTop: '2rem'}}>
        <div className="container">
          <h2 style={{marginBottom: '0.5rem'}}>My Services</h2>
          <p style={{textAlign: 'center', fontSize: '1.1rem', color: '#a0a0a0', marginBottom: '2rem', maxWidth: '600px', margin: '0 auto 2rem', marginTop: '0.5rem'}}>
            I provide comprehensive solutions for all your property and lifestyle needs
          </p>
          ...
          <div style={{textAlign: 'center', marginTop: '4rem'}}>
            ...
            <p style={{fontSize: '1.1rem', color: '#a0a0a0', marginBottom: '2rem'}}>
              Contact me today to discuss your needs and get a personalized quote
            </p>
