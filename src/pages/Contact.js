            ...
            <div className="contact-info-section">
              ...
              <div style={{marginBottom: '3rem'}}>
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <a href="tel:+971509571077" style={{color: '#666', textDecoration: 'none'}}>+971 50 957 1077</a>
                  </div>
                </div>
              ...
              <div>
                ...
                <div style={{display: 'flex', gap: '1rem'}}>
                  <a href="https://www.linkedin.com/in/sameer-farooq-0415b3246/" style={{
                    width: '45px',
                    height: '45px',
                    background: '#0077B5',
                    borderRadius: '50%',
                  ...
                  <a href="https://www.instagram.com/sameerfarooqdxb/" style={{
                    width: '45px',
                    height: '45px',
                    background: '#E4405F',
                    borderRadius: '50%',
                  ...
                  <a href="https://wa.me/971509571077" style={{
                    width: '45px',
                    height: '45px',
                    background: '#25D366',
                    borderRadius: '50%',
